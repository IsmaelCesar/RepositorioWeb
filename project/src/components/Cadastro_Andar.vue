    ...
    <br>
     ...
     <b-form-group id="exampleInputGroup2"
                    ...
                    label-for="exampleInput2"
                      description="Digite a quantidade de andares se todos possuirem as mesmas especificações.">
        <b-form-input id="exampleInput2"
                      type="number"
                      v-model="form.quantAndar"
                      required
                      placeholder="10">
        </b-form-input>
      </b-form-group>
